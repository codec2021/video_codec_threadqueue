...
g_sig_last_scan_8x8 DD 00H
	...
	DD	01H
	DD	03H
PUBLIC	kvz_init_constraint
PUBLIC	kvz_constraint_free
pdata	SEGMENT
$pdata$kvz_init_constraint DD imagerel $LN16
	DD	imagerel $LN16+331
	DD	imagerel $unwind$kvz_init_constraint
$pdata$kvz_constraint_free DD imagerel $LN7
	DD	imagerel $LN7+90
	DD	imagerel $unwind$kvz_constraint_free
xdata	SEGMENT
$unwind$kvz_init_constraint DD 040a01H
	DD	06340aH
	DD	07006320aH
$unwind$kvz_constraint_free DD 040a01H
	DD	06340aH
	DD	07006320aH
	ORG $+1
$SG4294945908 DB '0', 00H, 00H, 00H
	ORG $+6
$SG4294945910 DB 'Memory allocation failed!', 0aH, 00H
	ORG $+6
$SG4294945909 DB 'F', 00H, ':', 00H, '\', 00H, 'o', 00H, 'p', 00H, 'e', 00H
	...
	DB	00H, 'n', 00H, 't', 00H, '.', 00H, 'c', 00H, 00H, 00H
