; Listing generated by Microsoft (R) Optimizing Compiler Version 19.26.28806.0 
	...
	TITLE	F:\open_codec_learn_2021\kvazaar-master\src\strategies\strategies-sao.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
COMM	_kvz_sao_edge_ddistortion:DWORD
COMM	_kvz_calc_sao_edge_dir:DWORD
COMM	_kvz_sao_reconstruct_color:DWORD
COMM	_kvz_sao_band_ddistortion:DWORD
_DATA	ENDS
msvcjmc	SEGMENT
...
__9FD271FC_strategies-sao@c DB 01H
msvcjmc	ENDS
...
_strategies_to_select DD FLAT:??_C@_0P@FIMIKDEG@array_checksum@
	...
	DD	00H
CONST	ENDS
PUBLIC	_kvz_strategy_register_sao
PUBLIC	__JustMyCode_Default
EXTRN	_kvz_strategy_register_sao_avx2:PROC
EXTRN	_kvz_strategy_register_sao_generic:PROC
...
;	COMDAT _kvz_strategy_register_sao
_TEXT	SEGMENT
tv79 = -208						; size = 4
tv70 = -208						; size = 4
_success$ = -5						; size = 1
_opaque$ = 8						; size = 4
_bitdepth$ = 12						; size = 1
_kvz_strategy_register_sao PROC				; COMDAT
...
; 46   : int kvz_strategy_register_sao(void* opaque, uint8_t bitdepth) {
	...
	rep stosd
	mov	ecx, OFFSET __9FD271FC_strategies-sao@c
...
; 48   : 
; 49   :   success &= kvz_strategy_register_sao_generic(opaque, bitdepth);
	...
	push	ecx
	call	_kvz_strategy_register_sao_generic
	add	esp, 8
	and	esi, eax
...
; 52   :     success &= kvz_strategy_register_sao_avx2(opaque, bitdepth);
	...
	mov	ecx, DWORD PTR _opaque$[ebp]
	push	ecx
	call	_kvz_strategy_register_sao_avx2
	add	esp, 8
	and	esi, eax
...
; 56   : }
	...
	pop	ebp
	ret	0
_kvz_strategy_register_sao ENDP
_TEXT	ENDS
END
