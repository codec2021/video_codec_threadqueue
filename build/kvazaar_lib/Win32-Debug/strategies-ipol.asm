; Listing generated by Microsoft (R) Optimizing Compiler Version 19.26.28806.0 
	...
	TITLE	F:\open_codec_learn_2021\kvazaar-master\src\strategies\strategies-ipol.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
COMM	_kvz_filter_hpel_blocks_hor_ver_luma:DWORD
COMM	_kvz_filter_hpel_blocks_diag_luma:DWORD
COMM	_kvz_filter_qpel_blocks_hor_ver_luma:DWORD
COMM	_kvz_filter_qpel_blocks_diag_luma:DWORD
COMM	_kvz_get_extended_block:DWORD
COMM	_kvz_sample_quarterpel_luma:DWORD
COMM	_kvz_sample_octpel_chroma:DWORD
COMM	_kvz_sample_quarterpel_luma_hi:DWORD
COMM	_kvz_sample_octpel_chroma_hi:DWORD
_DATA	ENDS
msvcjmc	SEGMENT
...
__A92BAB8D_strategies-ipol@c DB 01H
msvcjmc	ENDS
...
_strategies_to_select DD FLAT:??_C@_0P@FIMIKDEG@array_checksum@
	...
	DD	00H
CONST	ENDS
PUBLIC	_kvz_strategy_register_ipol
PUBLIC	__JustMyCode_Default
EXTRN	_kvz_strategy_register_ipol_avx2:PROC
EXTRN	_kvz_strategy_register_ipol_generic:PROC
...
;	COMDAT _kvz_strategy_register_ipol
_TEXT	SEGMENT
tv79 = -208						; size = 4
tv70 = -208						; size = 4
_success$ = -5						; size = 1
_opaque$ = 8						; size = 4
_bitdepth$ = 12						; size = 1
_kvz_strategy_register_ipol PROC			; COMDAT
...
; 52   : int kvz_strategy_register_ipol(void* opaque, uint8_t bitdepth) {
	...
	rep stosd
	mov	ecx, OFFSET __A92BAB8D_strategies-ipol@c
...
; 54   : 
; 55   :   success &= kvz_strategy_register_ipol_generic(opaque, bitdepth);
	...
	push	ecx
	call	_kvz_strategy_register_ipol_generic
	add	esp, 8
	and	esi, eax
...
; 58   :     success &= kvz_strategy_register_ipol_avx2(opaque, bitdepth);
	...
	mov	ecx, DWORD PTR _opaque$[ebp]
	push	ecx
	call	_kvz_strategy_register_ipol_avx2
	add	esp, 8
	and	esi, eax
...
; 61   : }
	...
	pop	ebp
	ret	0
_kvz_strategy_register_ipol ENDP
_TEXT	ENDS
END
