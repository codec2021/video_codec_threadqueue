; Listing generated by Microsoft (R) Optimizing Compiler Version 19.26.28806.0 
	...
	TITLE	F:\open_codec_learn_2021\kvazaar-master\src\strategies\strategies-intra.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
COMM	_kvz_angular_pred:DWORD
COMM	_kvz_intra_pred_planar:DWORD
COMM	_kvz_intra_pred_filtered_dc:DWORD
_DATA	ENDS
msvcjmc	SEGMENT
...
__E720FAB5_strategies-intra@c DB 01H
msvcjmc	ENDS
...
_strategies_to_select DD FLAT:??_C@_0P@FIMIKDEG@array_checksum@
	...
	DD	00H
CONST	ENDS
PUBLIC	_kvz_strategy_register_intra
PUBLIC	__JustMyCode_Default
EXTRN	_kvz_strategy_register_intra_avx2:PROC
EXTRN	_kvz_strategy_register_intra_generic:PROC
...
;	COMDAT _kvz_strategy_register_intra
_TEXT	SEGMENT
tv79 = -208						; size = 4
tv70 = -208						; size = 4
_success$ = -5						; size = 1
_opaque$ = 8						; size = 4
_bitdepth$ = 12						; size = 1
_kvz_strategy_register_intra PROC			; COMDAT
...
; 45   : int kvz_strategy_register_intra(void* opaque, uint8_t bitdepth) {
	...
	rep stosd
	mov	ecx, OFFSET __E720FAB5_strategies-intra@c
...
; 47   : 
; 48   :   success &= kvz_strategy_register_intra_generic(opaque, bitdepth);
	...
	push	ecx
	call	_kvz_strategy_register_intra_generic
	add	esp, 8
	and	esi, eax
...
; 51   :     success &= kvz_strategy_register_intra_avx2(opaque, bitdepth);
	...
	mov	ecx, DWORD PTR _opaque$[ebp]
	push	ecx
	call	_kvz_strategy_register_intra_avx2
	add	esp, 8
	and	esi, eax
...
; 55   : }
	...
	pop	ebp
	ret	0
_kvz_strategy_register_intra ENDP
_TEXT	ENDS
END
