; Listing generated by Microsoft (R) Optimizing Compiler Version 19.26.28806.0 
	...
	TITLE	F:\open_codec_learn_2021\kvazaar-master\src\strategies\strategies-quant.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
COMM	_kvz_quant:DWORD
COMM	_kvz_quantize_residual:DWORD
COMM	_kvz_dequant:DWORD
COMM	_kvz_coeff_abs_sum:DWORD
COMM	_kvz_fast_coeff_cost:DWORD
_DATA	ENDS
msvcjmc	SEGMENT
...
__72224B0A_strategies-quant@c DB 01H
msvcjmc	ENDS
...
_strategies_to_select DD FLAT:??_C@_0P@FIMIKDEG@array_checksum@
	...
	DD	00H
CONST	ENDS
PUBLIC	_kvz_strategy_register_quant
PUBLIC	__JustMyCode_Default
EXTRN	_kvz_strategy_register_quant_avx2:PROC
EXTRN	_kvz_strategy_register_quant_generic:PROC
...
;	COMDAT _kvz_strategy_register_quant
_TEXT	SEGMENT
tv79 = -208						; size = 4
tv70 = -208						; size = 4
_success$ = -5						; size = 1
_opaque$ = 8						; size = 4
_bitdepth$ = 12						; size = 1
_kvz_strategy_register_quant PROC			; COMDAT
...
; 48   : int kvz_strategy_register_quant(void* opaque, uint8_t bitdepth) {
	...
	rep stosd
	mov	ecx, OFFSET __72224B0A_strategies-quant@c
...
; 50   : 
; 51   :   success &= kvz_strategy_register_quant_generic(opaque, bitdepth);
	...
	push	ecx
	call	_kvz_strategy_register_quant_generic
	add	esp, 8
	and	esi, eax
...
; 54   :     success &= kvz_strategy_register_quant_avx2(opaque, bitdepth);
	...
	mov	ecx, DWORD PTR _opaque$[ebp]
	push	ecx
	call	_kvz_strategy_register_quant_avx2
	add	esp, 8
	and	esi, eax
...
; 57   : }
	...
	pop	ebp
	ret	0
_kvz_strategy_register_quant ENDP
_TEXT	ENDS
END
